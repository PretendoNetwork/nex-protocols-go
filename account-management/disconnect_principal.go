...
func (protocol *AccountManagementProtocol) DisconnectPrincipal(handler func(err error, client *nex.Client, callID uint32, idPrincipal uint32)) {
	protocol.disconnectPrincipalHandler = handler
}

func (protocol *AccountManagementProtocol) handleDisconnectPrincipal(packet nex.PacketInterface) {
