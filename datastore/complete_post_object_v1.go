...
func (protocol *DataStoreProtocol) CompletePostObjectV1(handler func(err error, client *nex.Client, callID uint32, dataStoreCompletePostParamV1 *DataStoreCompletePostParamV1)) {
...
func (protocol *DataStoreProtocol) HandleCompletePostObjectV1(packet nex.PacketInterface) {
	...
	dataStoreCompletePostParamV1, err := parametersStream.ReadStructure(NewDataStoreCompletePostParamV1())
	if err != nil {
	...
	go protocol.CompletePostObjectV1Handler(nil, client, callID, dataStoreCompletePostParamV1.(*DataStoreCompletePostParamV1))
}
