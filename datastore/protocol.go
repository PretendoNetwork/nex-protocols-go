...
type Protocol struct {
	...
	DeleteObjects                func(err error, packet nex.PacketInterface, callID uint32, params types.List[datastore_types.DataStoreDeleteParam], transactional types.Bool) (*nex.RMCMessage, *nex.Error)
	...
	ChangeMetasV1                func(err error, packet nex.PacketInterface, callID uint32, dataIDs types.List[types.UInt64], params types.List[datastore_types.DataStoreChangeMetaParamV1], transactional types.Bool) (*nex.RMCMessage, *nex.Error)
	...
	GetMetas                     func(err error, packet nex.PacketInterface, callID uint32, dataIDs types.List[types.UInt64], param datastore_types.DataStoreGetMetaParam) (*nex.RMCMessage, *nex.Error)
	...
	GetRatingWithLog             func(err error, packet nex.PacketInterface, callID uint32, target datastore_types.DataStoreRatingTarget, accessPassword types.UInt64) (*nex.RMCMessage, *nex.Error)
	...
	GetPersistenceInfo           func(err error, packet nex.PacketInterface, callID uint32, ownerID types.PID, persistenceSlotID types.UInt16) (*nex.RMCMessage, *nex.Error)
	GetPersistenceInfos          func(err error, packet nex.PacketInterface, callID uint32, ownerID types.PID, persistenceSlotIDs types.List[types.UInt16]) (*nex.RMCMessage, *nex.Error)
	PerpetuateObject             func(err error, packet nex.PacketInterface, callID uint32, persistenceSlotID types.UInt16, dataID types.UInt64, deleteLastObject types.Bool) (*nex.RMCMessage, *nex.Error)
	UnperpetuateObject           func(err error, packet nex.PacketInterface, callID uint32, persistenceSlotID types.UInt16, deleteLastObject types.Bool) (*nex.RMCMessage, *nex.Error)
	...
	GetPasswordInfo              func(err error, packet nex.PacketInterface, callID uint32, dataID types.UInt64) (*nex.RMCMessage, *nex.Error)
	GetPasswordInfos             func(err error, packet nex.PacketInterface, callID uint32, dataIDs types.List[types.UInt64]) (*nex.RMCMessage, *nex.Error)
	...
	CompletePostObjects          func(err error, packet nex.PacketInterface, callID uint32, dataIDs types.List[types.UInt64]) (*nex.RMCMessage, *nex.Error)
	...
	ChangeMetas                  func(err error, packet nex.PacketInterface, callID uint32, dataIDs types.List[types.UInt64], params types.List[datastore_types.DataStoreChangeMetaParam], transactional types.Bool) (*nex.RMCMessage, *nex.Error)
	RateObjects                  func(err error, packet nex.PacketInterface, callID uint32, targets types.List[datastore_types.DataStoreRatingTarget], params types.List[datastore_types.DataStoreRateObjectParam], transactional types.Bool, fetchRatings types.Bool) (*nex.RMCMessage, *nex.Error)
	PostMetaBinaryWithDataID     func(err error, packet nex.PacketInterface, callID uint32, dataID types.UInt64, param datastore_types.DataStorePreparePostParam) (*nex.RMCMessage, *nex.Error)
...
type Interface interface {
	...
	SetHandlerDeleteObjects(handler func(err error, packet nex.PacketInterface, callID uint32, params types.List[datastore_types.DataStoreDeleteParam], transactional types.Bool) (*nex.RMCMessage, *nex.Error))
	...
	SetHandlerChangeMetasV1(handler func(err error, packet nex.PacketInterface, callID uint32, dataIDs types.List[types.UInt64], params types.List[datastore_types.DataStoreChangeMetaParamV1], transactional types.Bool) (*nex.RMCMessage, *nex.Error))
	...
	SetHandlerGetMetas(handler func(err error, packet nex.PacketInterface, callID uint32, dataIDs types.List[types.UInt64], param datastore_types.DataStoreGetMetaParam) (*nex.RMCMessage, *nex.Error))
	...
	SetHandlerGetRatingWithLog(handler func(err error, packet nex.PacketInterface, callID uint32, target datastore_types.DataStoreRatingTarget, accessPassword types.UInt64) (*nex.RMCMessage, *nex.Error))
	...
	SetHandlerGetPersistenceInfo(handler func(err error, packet nex.PacketInterface, callID uint32, ownerID types.PID, persistenceSlotID types.UInt16) (*nex.RMCMessage, *nex.Error))
	SetHandlerGetPersistenceInfos(handler func(err error, packet nex.PacketInterface, callID uint32, ownerID types.PID, persistenceSlotIDs types.List[types.UInt16]) (*nex.RMCMessage, *nex.Error))
	SetHandlerPerpetuateObject(handler func(err error, packet nex.PacketInterface, callID uint32, persistenceSlotID types.UInt16, dataID types.UInt64, deleteLastObject types.Bool) (*nex.RMCMessage, *nex.Error))
	SetHandlerUnperpetuateObject(handler func(err error, packet nex.PacketInterface, callID uint32, persistenceSlotID types.UInt16, deleteLastObject types.Bool) (*nex.RMCMessage, *nex.Error))
	...
	SetHandlerGetPasswordInfo(handler func(err error, packet nex.PacketInterface, callID uint32, dataID types.UInt64) (*nex.RMCMessage, *nex.Error))
	SetHandlerGetPasswordInfos(handler func(err error, packet nex.PacketInterface, callID uint32, dataIDs types.List[types.UInt64]) (*nex.RMCMessage, *nex.Error))
	...
	SetHandlerCompletePostObjects(handler func(err error, packet nex.PacketInterface, callID uint32, dataIDs types.List[types.UInt64]) (*nex.RMCMessage, *nex.Error))
	...
	SetHandlerChangeMetas(handler func(err error, packet nex.PacketInterface, callID uint32, dataIDs types.List[types.UInt64], params types.List[datastore_types.DataStoreChangeMetaParam], transactional types.Bool) (*nex.RMCMessage, *nex.Error))
	SetHandlerRateObjects(handler func(err error, packet nex.PacketInterface, callID uint32, targets types.List[datastore_types.DataStoreRatingTarget], params types.List[datastore_types.DataStoreRateObjectParam], transactional types.Bool, fetchRatings types.Bool) (*nex.RMCMessage, *nex.Error))
	SetHandlerPostMetaBinaryWithDataID(handler func(err error, packet nex.PacketInterface, callID uint32, dataID types.UInt64, param datastore_types.DataStorePreparePostParam) (*nex.RMCMessage, *nex.Error))
...
func (protocol *Protocol) SetHandlerDeleteObjects(handler func(err error, packet nex.PacketInterface, callID uint32, params types.List[datastore_types.DataStoreDeleteParam], transactional types.Bool) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerChangeMetasV1(handler func(err error, packet nex.PacketInterface, callID uint32, dataIDs types.List[types.UInt64], params types.List[datastore_types.DataStoreChangeMetaParamV1], transactional types.Bool) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerGetMetas(handler func(err error, packet nex.PacketInterface, callID uint32, dataIDs types.List[types.UInt64], param datastore_types.DataStoreGetMetaParam) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerRateObject(handler func(err error, packet nex.PacketInterface, callID uint32, target datastore_types.DataStoreRatingTarget, param datastore_types.DataStoreRateObjectParam, fetchRatings types.Bool) (*nex.RMCMessage, *nex.Error)) {
	protocol.RateObject = handler
}

// SetHandlerGetRating sets the handler for the GetRating method
func (protocol *Protocol) SetHandlerGetRating(handler func(err error, packet nex.PacketInterface, callID uint32, target datastore_types.DataStoreRatingTarget, accessPassword types.UInt64) (*nex.RMCMessage, *nex.Error)) {
	protocol.GetRating = handler
}

// SetHandlerGetRatings sets the handler for the GetRatings method
func (protocol *Protocol) SetHandlerGetRatings(handler func(err error, packet nex.PacketInterface, callID uint32, dataIDs types.List[types.UInt64], accessPassword types.UInt64) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerGetRatingWithLog(handler func(err error, packet nex.PacketInterface, callID uint32, target datastore_types.DataStoreRatingTarget, accessPassword types.UInt64) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerGetPersistenceInfo(handler func(err error, packet nex.PacketInterface, callID uint32, ownerID types.PID, persistenceSlotID types.UInt16) (*nex.RMCMessage, *nex.Error)) {
	protocol.GetPersistenceInfo = handler
}

// SetHandlerGetPersistenceInfos sets the handler for the GetPersistenceInfos method
func (protocol *Protocol) SetHandlerGetPersistenceInfos(handler func(err error, packet nex.PacketInterface, callID uint32, ownerID types.PID, persistenceSlotIDs types.List[types.UInt16]) (*nex.RMCMessage, *nex.Error)) {
	protocol.GetPersistenceInfos = handler
}

// SetHandlerPerpetuateObject sets the handler for the PerpetuateObject method
func (protocol *Protocol) SetHandlerPerpetuateObject(handler func(err error, packet nex.PacketInterface, callID uint32, persistenceSlotID types.UInt16, dataID types.UInt64, deleteLastObject types.Bool) (*nex.RMCMessage, *nex.Error)) {
	protocol.PerpetuateObject = handler
}

// SetHandlerUnperpetuateObject sets the handler for the UnperpetuateObject method
func (protocol *Protocol) SetHandlerUnperpetuateObject(handler func(err error, packet nex.PacketInterface, callID uint32, persistenceSlotID types.UInt16, deleteLastObject types.Bool) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerGetPasswordInfo(handler func(err error, packet nex.PacketInterface, callID uint32, dataID types.UInt64) (*nex.RMCMessage, *nex.Error)) {
	protocol.GetPasswordInfo = handler
}

// SetHandlerGetPasswordInfos sets the handler for the GetPasswordInfos method
func (protocol *Protocol) SetHandlerGetPasswordInfos(handler func(err error, packet nex.PacketInterface, callID uint32, dataIDs types.List[types.UInt64]) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerCompletePostObjects(handler func(err error, packet nex.PacketInterface, callID uint32, dataIDs types.List[types.UInt64]) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerChangeMetas(handler func(err error, packet nex.PacketInterface, callID uint32, dataIDs types.List[types.UInt64], params types.List[datastore_types.DataStoreChangeMetaParam], transactional types.Bool) (*nex.RMCMessage, *nex.Error)) {
	protocol.ChangeMetas = handler
}

// SetHandlerRateObjects sets the handler for the RateObjects method
func (protocol *Protocol) SetHandlerRateObjects(handler func(err error, packet nex.PacketInterface, callID uint32, targets types.List[datastore_types.DataStoreRatingTarget], params types.List[datastore_types.DataStoreRateObjectParam], transactional types.Bool, fetchRatings types.Bool) (*nex.RMCMessage, *nex.Error)) {
	protocol.RateObjects = handler
}

// SetHandlerPostMetaBinaryWithDataID sets the handler for the PostMetaBinaryWithDataID method
func (protocol *Protocol) SetHandlerPostMetaBinaryWithDataID(handler func(err error, packet nex.PacketInterface, callID uint32, dataID types.UInt64, param datastore_types.DataStorePreparePostParam) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerPostMetaBinariesWithDataID(handler func(err error, packet nex.PacketInterface, callID uint32, dataIDs types.List[types.UInt64], params types.List[datastore_types.DataStorePreparePostParam], transactional types.Bool) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerRateObjectsWithPosting(handler func(err error, packet nex.PacketInterface, callID uint32, targets types.List[datastore_types.DataStoreRatingTarget], rateParams types.List[datastore_types.DataStoreRateObjectParam], postParams types.List[datastore_types.DataStorePreparePostParam], transactional types.Bool, fetchRatings types.Bool) (*nex.RMCMessage, *nex.Error)) {
