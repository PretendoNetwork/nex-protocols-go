...
type Protocol struct {
	...
	dataStoreProtocol
	GetObjectInfos                        func(err error, packet nex.PacketInterface, callID uint32, dataIDs *types.List[*types.PrimitiveU64]) (*nex.RMCMessage, uint32)
	...
	CustomSearchObject                    func(err error, packet nex.PacketInterface, callID uint32, condition *types.PrimitiveU32, param *datastore_types.DataStoreSearchParam) (*nex.RMCMessage, uint32)
	RateCustomRanking                     func(err error, packet nex.PacketInterface, callID uint32, params *types.List[*datastore_super_mario_maker_types.DataStoreRateCustomRankingParam]) (*nex.RMCMessage, uint32)
	...
	DeleteCustomRanking                   func(err error, packet nex.PacketInterface, callID uint32, dataIDList *types.List[*types.PrimitiveU64]) (*nex.RMCMessage, uint32)
	AddToBufferQueue                      func(err error, packet nex.PacketInterface, callID uint32, param *datastore_super_mario_maker_types.BufferQueueParam, buffer *types.QBuffer) (*nex.RMCMessage, uint32)
	AddToBufferQueues                     func(err error, packet nex.PacketInterface, callID uint32, params *types.List[*datastore_super_mario_maker_types.BufferQueueParam], buffers *types.List[*types.QBuffer]) (*nex.RMCMessage, uint32)
	...
	GetBufferQueues                       func(err error, packet nex.PacketInterface, callID uint32, params *types.List[*datastore_super_mario_maker_types.BufferQueueParam]) (*nex.RMCMessage, uint32)
	ClearBufferQueues                     func(err error, packet nex.PacketInterface, callID uint32, params *types.List[*datastore_super_mario_maker_types.BufferQueueParam]) (*nex.RMCMessage, uint32)
	...
	ConditionalSearchObject               func(err error, packet nex.PacketInterface, callID uint32, condition *types.PrimitiveU32, param *datastore_types.DataStoreSearchParam, extraData *types.List[*types.String]) (*nex.RMCMessage, uint32)
	...
	SetApplicationConfig                  func(err error, packet nex.PacketInterface, callID uint32, applicationID *types.PrimitiveU32, key *types.PrimitiveU32, value *types.PrimitiveS32) (*nex.RMCMessage, uint32)
	DeleteApplicationConfig               func(err error, packet nex.PacketInterface, callID uint32, applicationID *types.PrimitiveU32, key *types.PrimitiveU32) (*nex.RMCMessage, uint32)
	LatestCourseSearchObject              func(err error, packet nex.PacketInterface, callID uint32, param *datastore_types.DataStoreSearchParam, extraData *types.List[*types.String]) (*nex.RMCMessage, uint32)
	FollowingsLatestCourseSearchObject    func(err error, packet nex.PacketInterface, callID uint32, param *datastore_types.DataStoreSearchParam, extraData *types.List[*types.String]) (*nex.RMCMessage, uint32)
	RecommendedCourseSearchObject         func(err error, packet nex.PacketInterface, callID uint32, param *datastore_types.DataStoreSearchParam, extraData *types.List[*types.String]) (*nex.RMCMessage, uint32)
	ScoreRangeCascadedSearchObject        func(err error, packet nex.PacketInterface, callID uint32, param *datastore_types.DataStoreSearchParam, extraData *types.List[*types.String]) (*nex.RMCMessage, uint32)
	SuggestedCourseSearchObject           func(err error, packet nex.PacketInterface, callID uint32, param *datastore_types.DataStoreSearchParam, extraData *types.List[*types.String]) (*nex.RMCMessage, uint32)
	PreparePostObjectWithOwnerIDAndDataID func(err error, packet nex.PacketInterface, callID uint32, ownerID *types.PrimitiveU32, dataID *types.PrimitiveU64, param *datastore_types.DataStorePreparePostParam) (*nex.RMCMessage, uint32)
	CompletePostObjectWithOwnerID         func(err error, packet nex.PacketInterface, callID uint32, ownerID *types.PrimitiveU32, param *datastore_types.DataStoreCompletePostParam) (*nex.RMCMessage, uint32)
	...
	GetApplicationConfigString            func(err error, packet nex.PacketInterface, callID uint32, applicationID *types.PrimitiveU32) (*nex.RMCMessage, uint32)
	SetApplicationConfigString            func(err error, packet nex.PacketInterface, callID uint32, applicationID *types.PrimitiveU32, key *types.PrimitiveU32, value *types.String) (*nex.RMCMessage, uint32)
	GetDeletionReason                     func(err error, packet nex.PacketInterface, callID uint32, dataIDLst *types.List[*types.PrimitiveU64]) (*nex.RMCMessage, uint32)
	SetDeletionReason                     func(err error, packet nex.PacketInterface, callID uint32, dataIDLst *types.List[*types.PrimitiveU64], deletionReason *types.PrimitiveU32) (*nex.RMCMessage, uint32)
	GetMetasWithCourseRecord              func(err error, packet nex.PacketInterface, callID uint32, params *types.List[*datastore_super_mario_maker_types.DataStoreGetCourseRecordParam], metaParam *datastore_types.DataStoreGetMetaParam) (*nex.RMCMessage, uint32)
	CheckRateCustomRankingCounter         func(err error, packet nex.PacketInterface, callID uint32, applicationID *types.PrimitiveU32) (*nex.RMCMessage, uint32)
	ResetRateCustomRankingCounter         func(err error, packet nex.PacketInterface, callID uint32, applicationID *types.PrimitiveU32) (*nex.RMCMessage, uint32)
	BestScoreRateCourseSearchObject       func(err error, packet nex.PacketInterface, callID uint32, param *datastore_types.DataStoreSearchParam, extraData *types.List[*types.String]) (*nex.RMCMessage, uint32)
	CTRPickUpCourseSearchObject           func(err error, packet nex.PacketInterface, callID uint32, param *datastore_types.DataStoreSearchParam, extraData *types.List[*types.String]) (*nex.RMCMessage, uint32)
	SetCachedRanking                      func(err error, packet nex.PacketInterface, callID uint32, rankingType *types.String, rankingArgs *types.List[*types.String], dataIDLst *types.List[*types.PrimitiveU64]) (*nex.RMCMessage, uint32)
	DeleteCachedRanking                   func(err error, packet nex.PacketInterface, callID uint32, rankingType *types.String, rankingArgs *types.List[*types.String]) (*nex.RMCMessage, uint32)
	ChangePlayablePlatform                func(err error, packet nex.PacketInterface, callID uint32, params *types.List[*datastore_super_mario_maker_types.DataStoreChangePlayablePlatformParam]) (*nex.RMCMessage, uint32)
