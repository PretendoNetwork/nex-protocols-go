...
type Protocol struct {
	...
	SetApplicationConfigString            func(err error, packet nex.PacketInterface, callID uint32, applicationID *types.PrimitiveU32, key *types.PrimitiveU32, value string) (*nex.RMCMessage, uint32)
	...
	SetCachedRanking                      func(err error, packet nex.PacketInterface, callID uint32, rankingType string, rankingArgs *types.List[*types.String], dataIDLst *types.List[*types.PrimitiveU64]) (*nex.RMCMessage, uint32)
	DeleteCachedRanking                   func(err error, packet nex.PacketInterface, callID uint32, rankingType string, rankingArgs *types.List[*types.String]) (*nex.RMCMessage, uint32)
