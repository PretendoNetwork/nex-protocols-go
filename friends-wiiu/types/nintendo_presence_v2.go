...
func (npv *NintendoPresenceV2) WriteTo(writable types.Writable) {
	...
	npv.ChangedFlags.WriteTo(writable)
	npv.Online.WriteTo(writable)
	npv.GameKey.WriteTo(writable)
	npv.Unknown1.WriteTo(writable)
	npv.Message.WriteTo(writable)
	npv.Unknown2.WriteTo(writable)
	npv.Unknown3.WriteTo(writable)
	npv.GameServerID.WriteTo(writable)
	npv.Unknown4.WriteTo(writable)
	npv.PID.WriteTo(writable)
	npv.GatheringID.WriteTo(writable)
	npv.ApplicationData.WriteTo(writable)
	npv.Unknown5.WriteTo(writable)
	npv.Unknown6.WriteTo(writable)
	npv.Unknown7.WriteTo(writable)
