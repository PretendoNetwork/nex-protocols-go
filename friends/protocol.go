...
type Protocol struct {
	...
	AddFriend                  func(err error, packet nex.PacketInterface, callID uint32, uiPlayer *types.PrimitiveU32, uiDetails *types.PrimitiveU32, strMessage string) (*nex.RMCMessage, uint32)
	AddFriendByName            func(err error, packet nex.PacketInterface, callID uint32, strPlayerName string, uiDetails *types.PrimitiveU32, strMessage string) (*nex.RMCMessage, uint32)
	AddFriendWithDetails       func(err error, packet nex.PacketInterface, callID uint32, uiPlayer *types.PrimitiveU32, uiDetails *types.PrimitiveU32, strMessage string) (*nex.RMCMessage, uint32)
	AddFriendByNameWithDetails func(err error, packet nex.PacketInterface, callID uint32, uiPlayer *types.PrimitiveU32, uiDetails *types.PrimitiveU32, strMessage string) (*nex.RMCMessage, uint32) // TODO - Is this the right signature?
	...
	BlackListByName            func(err error, packet nex.PacketInterface, callID uint32, strPlayerName string, uiDetails *types.PrimitiveU32) (*nex.RMCMessage, uint32)
...
type Interface interface {
	...
	SetHandlerAddFriend(handler func(err error, packet nex.PacketInterface, callID uint32, uiPlayer *types.PrimitiveU32, uiDetails *types.PrimitiveU32, strMessage string) (*nex.RMCMessage, uint32))
	SetHandlerAddFriendByName(handler func(err error, packet nex.PacketInterface, callID uint32, strPlayerName string, uiDetails *types.PrimitiveU32, strMessage string) (*nex.RMCMessage, uint32))
	SetHandlerAddFriendWithDetails(handler func(err error, packet nex.PacketInterface, callID uint32, uiPlayer *types.PrimitiveU32, uiDetails *types.PrimitiveU32, strMessage string) (*nex.RMCMessage, uint32))
	SetHandlerAddFriendByNameWithDetails(handler func(err error, packet nex.PacketInterface, callID uint32, uiPlayer *types.PrimitiveU32, uiDetails *types.PrimitiveU32, strMessage string) (*nex.RMCMessage, uint32))
	...
	SetHandlerBlackListByName(handler func(err error, packet nex.PacketInterface, callID uint32, strPlayerName string, uiDetails *types.PrimitiveU32) (*nex.RMCMessage, uint32))
...
func (protocol *Protocol) SetHandlerAddFriend(handler func(err error, packet nex.PacketInterface, callID uint32, uiPlayer *types.PrimitiveU32, uiDetails *types.PrimitiveU32, strMessage string) (*nex.RMCMessage, uint32)) {
	protocol.AddFriend = handler
}

// SetHandlerAddFriendByName sets the handler for the AddFriendByName method
func (protocol *Protocol) SetHandlerAddFriendByName(handler func(err error, packet nex.PacketInterface, callID uint32, strPlayerName string, uiDetails *types.PrimitiveU32, strMessage string) (*nex.RMCMessage, uint32)) {
	protocol.AddFriendByName = handler
}

// SetHandlerAddFriendWithDetails sets the handler for the AddFriendWithDetails method
func (protocol *Protocol) SetHandlerAddFriendWithDetails(handler func(err error, packet nex.PacketInterface, callID uint32, uiPlayer *types.PrimitiveU32, uiDetails *types.PrimitiveU32, strMessage string) (*nex.RMCMessage, uint32)) {
...
func (protocol *Protocol) SetHandlerAddFriendByNameWithDetails(handler func(err error, packet nex.PacketInterface, callID uint32, uiPlayer *types.PrimitiveU32, uiDetails *types.PrimitiveU32, strMessage string) (*nex.RMCMessage, uint32)) {
...
func (protocol *Protocol) SetHandlerBlackListByName(handler func(err error, packet nex.PacketInterface, callID uint32, strPlayerName string, uiDetails *types.PrimitiveU32) (*nex.RMCMessage, uint32)) {
