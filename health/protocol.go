...
type Protocol struct {
	...
	pingDatabaseHandler    func(err error, client *nex.Client, callID uint32) uint32
	runSanityCheckHandler  func(err error, client *nex.Client, callID uint32) uint32
	fixSanityErrorsHandler func(err error, client *nex.Client, callID uint32) uint32
}
