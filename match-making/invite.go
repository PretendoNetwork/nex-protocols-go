...
func (protocol *MatchMakingProtocol) Invite(handler func(err error, client *nex.Client, callID uint32, idGathering uint32, lstPrincipals []uint32, strMessage string)) {
	protocol.inviteHandler = handler
}

func (protocol *MatchMakingProtocol) handleInvite(packet nex.PacketInterface) {
