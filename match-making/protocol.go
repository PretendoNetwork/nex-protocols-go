...
type Protocol struct {
	...
	updateGatheringHandler             func(err error, client *nex.Client, callID uint32, anyGathering *nex.DataHolder)
	inviteHandler                      func(err error, client *nex.Client, callID uint32, idGathering uint32, lstPrincipals []uint32, strMessage string)
	acceptInvitationHandler            func(err error, client *nex.Client, callID uint32, idGathering uint32, strMessage string)
	declineInvitationHandler           func(err error, client *nex.Client, callID uint32, idGathering uint32, strMessage string)
	cancelInvitationHandler            func(err error, client *nex.Client, callID uint32, idGathering uint32, lstPrincipals []uint32, strMessage string)
	getInvitationsSentHandler          func(err error, client *nex.Client, callID uint32, idGathering uint32)
	getInvitationsReceivedHandler      func(err error, client *nex.Client, callID uint32)
	participateHandler                 func(err error, client *nex.Client, callID uint32, idGathering uint32, strMessage string)
	cancelParticipationHandler         func(err error, client *nex.Client, callID uint32, idGathering uint32, strMessage string)
	getParticipantsHandler             func(err error, client *nex.Client, callID uint32, idGathering uint32)
	addParticipantsHandler             func(err error, client *nex.Client, callID uint32, idGathering uint32, lstPrincipals []uint32, strMessage string)
	getDetailedParticipantsHandler     func(err error, client *nex.Client, callID uint32, idGathering uint32)
	getParticipantsURLsHandler         func(err error, client *nex.Client, callID uint32, idGathering uint32)
	findByTypeHandler                  func(err error, client *nex.Client, callID uint32, strType string, resultRange *nex.ResultRange)
	findByDescriptionHandler           func(err error, client *nex.Client, callID uint32, strDescription string, resultRange *nex.ResultRange)
	findByDescriptionRegexHandler      func(err error, client *nex.Client, callID uint32, strDescriptionRegex string, resultRange *nex.ResultRange)
	findByIDHandler                    func(err error, client *nex.Client, callID uint32, lstID []uint32)
	findBySingleIDHandler              func(err error, client *nex.Client, callID uint32, id uint32)
	findByOwnerHandler                 func(err error, client *nex.Client, callID uint32, id uint32, resultRange *nex.ResultRange)
	findByParticipantsHandler          func(err error, client *nex.Client, callID uint32, pid []uint32)
	findInvitationsHandler             func(err error, client *nex.Client, callID uint32, resultRange *nex.ResultRange)
	findBySQLQueryHandler              func(err error, client *nex.Client, callID uint32, strQuery string, resultRange *nex.ResultRange)
	launchSessionHandler               func(err error, client *nex.Client, callID uint32, idGathering uint32, strURL string)
	updateSessionURLHandler            func(err error, client *nex.Client, callID uint32, idGathering uint32, strURL string)
	getSessionURLHandler               func(err error, client *nex.Client, callID uint32, idGathering uint32)
	getStateHandler                    func(err error, client *nex.Client, callID uint32, idGathering uint32)
	setStateHandler                    func(err error, client *nex.Client, callID uint32, idGathering uint32, uiNewState uint32)
	reportStatsHandler                 func(err error, client *nex.Client, callID uint32, idGathering uint32, lstStats []*match_making_types.GatheringStats)
	getStatsHandler                    func(err error, client *nex.Client, callID uint32, idGathering uint32, lstParticipants []uint32, lstColumns []byte)
	deleteGatheringHandler             func(err error, client *nex.Client, callID uint32, idGathering uint32)
	getPendingDeletionsHandler         func(err error, client *nex.Client, callID uint32, uiReason uint32, resultRange *nex.ResultRange)
	deleteFromDeletionsHandler         func(err error, client *nex.Client, callID uint32, lstDeletions []uint32)
	migrateGatheringOwnershipV1Handler func(err error, client *nex.Client, callID uint32, gid uint32, lstPotentialNewOwnersID []uint32)
	findByDescriptionLikeHandler       func(err error, client *nex.Client, callID uint32, strDescriptionLike string, resultRange *nex.ResultRange)
	registerLocalURLHandler            func(err error, client *nex.Client, callID uint32, gid uint32, url *nex.StationURL)
	registerLocalURLsHandler           func(err error, client *nex.Client, callID uint32, gid uint32, lstURLs []*nex.StationURL)
	...
	updateGatheringOwnershipHandler    func(err error, client *nex.Client, callID uint32, gid uint32, participantsOnly bool)
	migrateGatheringOwnershipHandler   func(err error, client *nex.Client, callID uint32, gid uint32, lstPotentialNewOwnersID []uint32, participantsOnly bool)
}
