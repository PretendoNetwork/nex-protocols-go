...
func (protocol *Protocol) UpdateFriendUserProfile(handler func(err error, client *nex.Client, callID uint32, param *matchmake_extension_monster_hunter_xx_types.FriendUserParam)) {
