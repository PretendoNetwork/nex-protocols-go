...
type Protocol struct {
	...
	JoinCommunity                                           func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32, strMessage types.String, strPassword types.String) (*nex.RMCMessage, *nex.Error)
	FindCommunityByGatheringID                              func(err error, packet nex.PacketInterface, callID uint32, lstGID types.List[types.UInt32]) (*nex.RMCMessage, *nex.Error)
	FindOfficialCommunity                                   func(err error, packet nex.PacketInterface, callID uint32, isAvailableOnly types.Bool, resultRange types.ResultRange) (*nex.RMCMessage, *nex.Error)
	...
	UpdatePrivacySetting                                    func(err error, packet nex.PacketInterface, callID uint32, onlineStatus types.Bool, participationCommunity types.Bool) (*nex.RMCMessage, *nex.Error)
	...
	ReportViolation                                         func(err error, packet nex.PacketInterface, callID uint32, pid types.PID, userName types.String, violationCode types.UInt32) (*nex.RMCMessage, *nex.Error)
	...
	FindMatchmakeSessionByGatheringIDDetail                 func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32) (*nex.RMCMessage, *nex.Error)
	...
	WithdrawMatchmaking                                     func(err error, packet nex.PacketInterface, callID uint32, requestID types.UInt64) (*nex.RMCMessage, *nex.Error)
	WithdrawMatchmakingAll                                  func(err error, packet nex.PacketInterface, callID uint32) (*nex.RMCMessage, *nex.Error)
	FindMatchmakeSessionByGatheringID                       func(err error, packet nex.PacketInterface, callID uint32, lstGID types.List[types.UInt32]) (*nex.RMCMessage, *nex.Error)
	FindMatchmakeSessionBySingleGatheringID                 func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32) (*nex.RMCMessage, *nex.Error)
	FindMatchmakeSessionByOwner                             func(err error, packet nex.PacketInterface, callID uint32, id types.UInt32, resultRange types.ResultRange) (*nex.RMCMessage, *nex.Error)
...
type Interface interface {
	...
	SetHandlerJoinCommunity(handler func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32, strMessage types.String, strPassword types.String) (*nex.RMCMessage, *nex.Error))
	SetHandlerFindCommunityByGatheringID(handler func(err error, packet nex.PacketInterface, callID uint32, lstGID types.List[types.UInt32]) (*nex.RMCMessage, *nex.Error))
	SetHandlerFindOfficialCommunity(handler func(err error, packet nex.PacketInterface, callID uint32, isAvailableOnly types.Bool, resultRange types.ResultRange) (*nex.RMCMessage, *nex.Error))
	...
	SetHandlerUpdatePrivacySetting(handler func(err error, packet nex.PacketInterface, callID uint32, onlineStatus types.Bool, participationCommunity types.Bool) (*nex.RMCMessage, *nex.Error))
	...
	SetHandlerReportViolation(handler func(err error, packet nex.PacketInterface, callID uint32, pid types.PID, userName types.String, violationCode types.UInt32) (*nex.RMCMessage, *nex.Error))
	...
	SetHandlerFindMatchmakeSessionByGatheringIDDetail(handler func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32) (*nex.RMCMessage, *nex.Error))
	...
	SetHandlerWithdrawMatchmaking(handler func(err error, packet nex.PacketInterface, callID uint32, requestID types.UInt64) (*nex.RMCMessage, *nex.Error))
	...
	SetHandlerFindMatchmakeSessionByGatheringID(handler func(err error, packet nex.PacketInterface, callID uint32, lstGID types.List[types.UInt32]) (*nex.RMCMessage, *nex.Error))
	SetHandlerFindMatchmakeSessionBySingleGatheringID(handler func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32) (*nex.RMCMessage, *nex.Error))
	SetHandlerFindMatchmakeSessionByOwner(handler func(err error, packet nex.PacketInterface, callID uint32, id types.UInt32, resultRange types.ResultRange) (*nex.RMCMessage, *nex.Error))
...
func (protocol *Protocol) SetHandlerCloseParticipation(handler func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32) (*nex.RMCMessage, *nex.Error)) {
	protocol.CloseParticipation = handler
}

// SetHandlerOpenParticipation sets the handler for the OpenParticipation method
func (protocol *Protocol) SetHandlerOpenParticipation(handler func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerJoinMatchmakeSession(handler func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32, strMessage types.String) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerModifyCurrentGameAttribute(handler func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32, attribIndex types.UInt32, newValue types.UInt32) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerUpdateApplicationBuffer(handler func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32, applicationBuffer types.Buffer) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerUpdateMatchmakeSessionAttribute(handler func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32, attribs types.List[types.UInt32]) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerJoinCommunity(handler func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32, strMessage types.String, strPassword types.String) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerFindCommunityByGatheringID(handler func(err error, packet nex.PacketInterface, callID uint32, lstGID types.List[types.UInt32]) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerFindOfficialCommunity(handler func(err error, packet nex.PacketInterface, callID uint32, isAvailableOnly types.Bool, resultRange types.ResultRange) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerUpdatePrivacySetting(handler func(err error, packet nex.PacketInterface, callID uint32, onlineStatus types.Bool, participationCommunity types.Bool) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerReportViolation(handler func(err error, packet nex.PacketInterface, callID uint32, pid types.PID, userName types.String, violationCode types.UInt32) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerJoinMatchmakeSessionEx(handler func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32, strMessage types.String, dontCareMyBlockList types.Bool, participationCount types.UInt16) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerGetSimplePlayingSession(handler func(err error, packet nex.PacketInterface, callID uint32, listPID types.List[types.PID], includeLoginUser types.Bool) (*nex.RMCMessage, *nex.Error)) {
	protocol.GetSimplePlayingSession = handler
}

// SetHandlerGetSimpleCommunity sets the handler for the GetSimpleCommunity method
func (protocol *Protocol) SetHandlerGetSimpleCommunity(handler func(err error, packet nex.PacketInterface, callID uint32, gatheringIDList types.List[types.UInt32]) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerUpdateProgressScore(handler func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32, progressScore types.UInt8) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerGenerateMatchmakeSessionSystemPassword(handler func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerClearMatchmakeSessionSystemPassword(handler func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerFindMatchmakeSessionByGatheringIDDetail(handler func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerWithdrawMatchmaking(handler func(err error, packet nex.PacketInterface, callID uint32, requestID types.UInt64) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerFindMatchmakeSessionByGatheringID(handler func(err error, packet nex.PacketInterface, callID uint32, lstGID types.List[types.UInt32]) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerFindMatchmakeSessionBySingleGatheringID(handler func(err error, packet nex.PacketInterface, callID uint32, gid types.UInt32) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerFindMatchmakeSessionByOwner(handler func(err error, packet nex.PacketInterface, callID uint32, id types.UInt32, resultRange types.ResultRange) (*nex.RMCMessage, *nex.Error)) {
