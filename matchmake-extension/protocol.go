...
type Protocol struct {
	...
	joinMatchmakeSessionHandler                                    func(err error, client *nex.Client, callID uint32, gid uint32, strMessage string)
	modifyCurrentGameAttributeHandler                              func(err error, client *nex.Client, callID uint32, gid uint32, attribIndex uint32, newValue uint32)
	...
	joinCommunityHandler                                           func(err error, client *nex.Client, callID uint32, gid uint32, strMessage string, strPassword string)
	...
	updatePrivacySettingHandler                                    func(err error, client *nex.Client, callID uint32, onlineStatus bool, participationCommunity bool)
	getMyBlockListHandler                                          func(err error, client *nex.Client, callID uint32)
	addToBlockListHandler                                          func(err error, client *nex.Client, callID uint32, lstPrincipalID []uint32)
	removeFromBlockListHandler                                     func(err error, client *nex.Client, callID uint32, lstPrincipalID []uint32)
	clearMyBlockListHandler                                        func(err error, client *nex.Client, callID uint32)
	reportViolationHandler                                         func(err error, client *nex.Client, callID uint32, pid uint32, userName string, violationCode uint32)
	isViolationUserHandler                                         func(err error, client *nex.Client, callID uint32)
	...
	updateMatchmakeSessionPartHandler                              func(err error, client *nex.Client, callID uint32, updateMatchmakeSessionParam *match_making_types.UpdateMatchmakeSessionParam)
	requestMatchmakingHandler                                      func(err error, client *nex.Client, callID uint32, autoMatchmakeParam *match_making_types.AutoMatchmakeParam)
	withdrawMatchmakingHandler                                     func(err error, client *nex.Client, callID uint32, requestID uint64)
	withdrawMatchmakingAllHandler                                  func(err error, client *nex.Client, callID uint32)
	findMatchmakeSessionByGatheringIDHandler                       func(err error, client *nex.Client, callID uint32, lstGID []uint32)
	findMatchmakeSessionBySingleGatheringIDHandler                 func(err error, client *nex.Client, callID uint32, gid uint32)
	findMatchmakeSessionByOwnerHandler                             func(err error, client *nex.Client, callID uint32, id uint32, resultRange *nex.ResultRange)
