...
type Protocol struct {
	...
	browseMatchmakeSessionHandler                                  func(err error, packet nex.PacketInterface, callID uint32, searchCriteria *match_making_types.MatchmakeSessionSearchCriteria, resultRange *nex.ResultRange) uint32
	browseMatchmakeSessionWithHostURLsHandler                      func(err error, packet nex.PacketInterface, callID uint32, searchCriteria *match_making_types.MatchmakeSessionSearchCriteria, resultRange *nex.ResultRange) uint32
	createMatchmakeSessionHandler                                  func(err error, packet nex.PacketInterface, callID uint32, anyGathering *nex.DataHolder, message string, participationCount uint16) uint32
	joinMatchmakeSessionHandler                                    func(err error, packet nex.PacketInterface, callID uint32, gid uint32, strMessage string) uint32
	modifyCurrentGameAttributeHandler                              func(err error, packet nex.PacketInterface, callID uint32, gid uint32, attribIndex uint32, newValue uint32) uint32
	updateNotificationDataHandler                                  func(err error, packet nex.PacketInterface, callID uint32, uiType uint32, uiParam1 uint32, uiParam2 uint32, strParam string) uint32
	getFriendNotificationDataHandler                               func(err error, packet nex.PacketInterface, callID uint32, uiType int32) uint32
	updateApplicationBufferHandler                                 func(err error, packet nex.PacketInterface, callID uint32, gid uint32, applicationBuffer []byte) uint32
	updateMatchmakeSessionAttributeHandler                         func(err error, packet nex.PacketInterface, callID uint32, gid uint32, attribs []uint32) uint32
	...
	joinMatchmakeSessionWithParamHandler                           func(err error, packet nex.PacketInterface, callID uint32, joinMatchmakeSessionParam *match_making_types.JoinMatchmakeSessionParam) uint32
	autoMatchmakeWithParamPostponeHandler                          func(err error, packet nex.PacketInterface, callID uint32, autoMatchmakeParam *match_making_types.AutoMatchmakeParam) uint32
	findMatchmakeSessionByGatheringIDDetailHandler                 func(err error, packet nex.PacketInterface, callID uint32, gid uint32) uint32
	browseMatchmakeSessionNoHolderHandler                          func(err error, packet nex.PacketInterface, callID uint32, searchCriteria *match_making_types.MatchmakeSessionSearchCriteria, resultRange *nex.ResultRange) uint32
	browseMatchmakeSessionWithHostURLsNoHolderHandler              func(err error, packet nex.PacketInterface, callID uint32, searchCriteria *match_making_types.MatchmakeSessionSearchCriteria, resultRange *nex.ResultRange) uint32
	updateMatchmakeSessionPartHandler                              func(err error, packet nex.PacketInterface, callID uint32, updateMatchmakeSessionParam *match_making_types.UpdateMatchmakeSessionParam) uint32
	requestMatchmakingHandler                                      func(err error, packet nex.PacketInterface, callID uint32, autoMatchmakeParam *match_making_types.AutoMatchmakeParam) uint32
	withdrawMatchmakingHandler                                     func(err error, packet nex.PacketInterface, callID uint32, requestID uint64) uint32
	withdrawMatchmakingAllHandler                                  func(err error, packet nex.PacketInterface, callID uint32) uint32
	findMatchmakeSessionByGatheringIDHandler                       func(err error, packet nex.PacketInterface, callID uint32, lstGID []uint32) uint32
	findMatchmakeSessionBySingleGatheringIDHandler                 func(err error, packet nex.PacketInterface, callID uint32, gid uint32) uint32
	findMatchmakeSessionByOwnerHandler                             func(err error, packet nex.PacketInterface, callID uint32, id uint32, resultRange *nex.ResultRange) uint32
	findMatchmakeSessionByParticipantHandler                       func(err error, packet nex.PacketInterface, callID uint32, param *match_making_types.FindMatchmakeSessionByParticipantParam) uint32
	browseMatchmakeSessionNoHolderNoResultRangeHandler             func(err error, packet nex.PacketInterface, callID uint32, searchCriteria *match_making_types.MatchmakeSessionSearchCriteria) uint32
	browseMatchmakeSessionWithHostURLsNoHolderNoResultRangeHandler func(err error, packet nex.PacketInterface, callID uint32, searchCriteria *match_making_types.MatchmakeSessionSearchCriteria) uint32
	findCommunityByOwnerHandler                                    func(err error, packet nex.PacketInterface, callID uint32, packetPayload []byte) uint32 // TODO - Unknown request/response format
}
