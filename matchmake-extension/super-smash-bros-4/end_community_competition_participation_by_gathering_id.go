...
func (protocol *Protocol) handleEndCommunityCompetitionParticipationByGatheringID(packet nex.PacketInterface) {
	if protocol.EndCommunityCompetitionParticipationByGatheringID == nil {
		err := nex.NewError(nex.ResultCodes.Core.NotImplemented, "MatchmakeExtensionSuperSmashBros4::EndCommunityCompetitionParticipationByGatheringID not implemented")
	...
	rmcMessage, rmcError := protocol.EndCommunityCompetitionParticipationByGatheringID(nil, packet, callID, packet.Payload())
	if rmcError != nil {
