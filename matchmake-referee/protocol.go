...
type Protocol struct {
	...
	GetStartRoundParam    func(err error, packet nex.PacketInterface, callID uint32, roundID types.UInt64) (*nex.RMCMessage, *nex.Error)
	...
	EndRoundWithoutReport func(err error, packet nex.PacketInterface, callID uint32, roundID types.UInt64) (*nex.RMCMessage, *nex.Error)
	GetRoundParticipants  func(err error, packet nex.PacketInterface, callID uint32, roundID types.UInt64) (*nex.RMCMessage, *nex.Error)
	GetNotSummarizedRound func(err error, packet nex.PacketInterface, callID uint32) (*nex.RMCMessage, *nex.Error)
	GetRound              func(err error, packet nex.PacketInterface, callID uint32, roundID types.UInt64) (*nex.RMCMessage, *nex.Error)
...
type Interface interface {
	...
	SetHandlerGetStartRoundParam(handler func(err error, packet nex.PacketInterface, callID uint32, roundID types.UInt64) (*nex.RMCMessage, *nex.Error))
	...
	SetHandlerEndRoundWithoutReport(handler func(err error, packet nex.PacketInterface, callID uint32, roundID types.UInt64) (*nex.RMCMessage, *nex.Error))
	SetHandlerGetRoundParticipants(handler func(err error, packet nex.PacketInterface, callID uint32, roundID types.UInt64) (*nex.RMCMessage, *nex.Error))
	SetHandlerGetNotSummarizedRound(handler func(err error, packet nex.PacketInterface, callID uint32) (*nex.RMCMessage, *nex.Error))
	SetHandlerGetRound(handler func(err error, packet nex.PacketInterface, callID uint32, roundID types.UInt64) (*nex.RMCMessage, *nex.Error))
...
func (protocol *Protocol) SetHandlerGetStartRoundParam(handler func(err error, packet nex.PacketInterface, callID uint32, roundID types.UInt64) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerEndRoundWithoutReport(handler func(err error, packet nex.PacketInterface, callID uint32, roundID types.UInt64) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerGetRoundParticipants(handler func(err error, packet nex.PacketInterface, callID uint32, roundID types.UInt64) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerGetRound(handler func(err error, packet nex.PacketInterface, callID uint32, roundID types.UInt64) (*nex.RMCMessage, *nex.Error)) {
