...
func (protocol *Protocol) GetCompetitionInfo(handler func(err error, client *nex.Client, callID uint32, param *ranking_mario_kart8_types.CompetitionRankingInfoGetParam)) {
