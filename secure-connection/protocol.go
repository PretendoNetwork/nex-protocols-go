...
type Protocol struct {
	...
	SendReport            func(err error, packet nex.PacketInterface, callID uint32, reportID types.UInt32, reportData types.QBuffer) (*nex.RMCMessage, *nex.Error)
...
type Interface interface {
	...
	SetHandlerSendReport(handler func(err error, packet nex.PacketInterface, callID uint32, reportID types.UInt32, reportData types.QBuffer) (*nex.RMCMessage, *nex.Error))
}
...
func (protocol *Protocol) SetHandlerRequestConnectionData(handler func(err error, packet nex.PacketInterface, callID uint32, cidTarget types.UInt32, pidTarget types.PID) (*nex.RMCMessage, *nex.Error)) {
	protocol.RequestConnectionData = handler
}

// SetHandlerRequestURLs sets the handler for the RequestURLs method
func (protocol *Protocol) SetHandlerRequestURLs(handler func(err error, packet nex.PacketInterface, callID uint32, cidTarget types.UInt32, pidTarget types.PID) (*nex.RMCMessage, *nex.Error)) {
...
func (protocol *Protocol) SetHandlerSendReport(handler func(err error, packet nex.PacketInterface, callID uint32, reportID types.UInt32, reportData types.QBuffer) (*nex.RMCMessage, *nex.Error)) {
