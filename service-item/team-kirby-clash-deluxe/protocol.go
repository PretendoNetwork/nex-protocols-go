...
type Protocol struct {
	...
	serviceItemProtocol
	GetEnvironment                  func(err error, packet nex.PacketInterface, callID uint32, uniqueID types.String, platform types.UInt8) (*nex.RMCMessage, *nex.Error)
	...
	GetServiceItemRightRequest      func(err error, packet nex.PacketInterface, callID uint32, getServiceItemRightParam service_item_team_kirby_clash_deluxe_types.ServiceItemGetServiceItemRightParam, withoutRightBinary types.Bool) (*nex.RMCMessage, *nex.Error)
	...
	UseServiceItemByAccountResponse func(err error, packet nex.PacketInterface, callID uint32, requestID types.UInt32) (*nex.RMCMessage, *nex.Error)
	...
	GetLawMessageResponse           func(err error, packet nex.PacketInterface, callID uint32, requestID types.UInt32) (*nex.RMCMessage, *nex.Error)
}
