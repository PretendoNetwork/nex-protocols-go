...
func (protocol *Protocol) SaveUserInfo(handler func(err error, client *nex.Client, callID uint32, userInfo *service_item_wii_sports_club_types.ServiceItemUserInfo)) {
