...
func (protocol *Protocol) StartChallenge(handler func(err error, client *nex.Client, callID uint32, startChallengeParam *service_item_wii_sports_club_types.ServiceItemStartChallengeParam)) {
